<template>
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow sticky-top">
        <div class="container-fluid">
            <router-link to="/" class="navbar-brand"><img class="img-fluid" src="../assets/images/logo.png" alt="Nishkarsh Logo" style="max-height: 60px;"></router-link> 
...
export default {
    ...
    computed: {
        ...
        menuItems () {
            let menuItems = [
                {title: 'Home', link: '/'},
                {title: 'All Organizations', link: '/organizations'},
