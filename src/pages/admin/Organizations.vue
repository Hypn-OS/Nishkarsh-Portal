                        ...
                        <table class="table table-bordered table-hover table-responsive-sm" v-if="!loading && organizations != ''">
                            ...
                            <tbody>
                                ...
                                <th>
                                    ...
                                    <span class="badge badge-primary mr-2" title="State">{{ organization.state }}</span>
                                    <span class="badge badge-info" title="Expertise">{{ organization.expertise }}</span>
                                </th>
