                ...
                <div class="col-md-8 offset-md-2 card shadow my-md-4 py-3">
                    <div class="row">
                        <div v-if="!loading" class="col-md-12">
                            ...
                            <h1 class="h4">History of the organization</h1>
                            <table class="table table-bordered table-hover table-responsive-sm" v-if="!loading">
                                <tbody>
                                    <tr>
                                        <td>Total Cases registered against the organization</td>
                                        <th>{{ organization.total_cases }}</th>
                                    </tr>
                                    <tr>
                                        <td>Cases Pending</td>
                                        <th>{{ organization.cases_pending }}</th>
                                    </tr>
                                    <tr>
                                        <td>Cases closed against the organization</td>
                                        <th>{{ organization.cases_closed_against }}</th>
                                    </tr>
                                    <tr>
                                        <td>Cases closed in favor of the organization</td>
                                        <th>{{ organization.cases_closed_favor }}</th>
                                    </tr>
                                    <tr>
                                        <td>Organization Reputation</td>
                                        <th><span class="badge badge-secondary">{{ organization.reputation }}</span></th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
